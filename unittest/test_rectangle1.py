import numpy as np
import cv2
#参考文章:openCV提取图像中的矩形区域:https://blog.csdn.net/c19961227/article/details/90693098

# 这个成功的扣下了ppt白板
srcPic = cv2.imread('/Users/xh/Downloads/ks/vision-ui/unittest/green.png')
...
print("dstImage:",dstImage)
cv2.imwrite('rectangle.png', dstImage)
# # 等待一个按下键盘事件
cv2.waitKey(0)
# 销毁所有创建出的窗口